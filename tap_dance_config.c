...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_ESC_CAPS] = ACTION_TAP_DANCE_DOUBLE(KC_ESC, KC_CAPS), [TD_COMMA] = ACTION_TAP_DANCE_DOUBLE(KC_COMMA, KC_DOT), [TD_COL_PIPE] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, col_finished, col_reset), [TD_L_BRA] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, l_bra_finished, l_bra_reset), [TD_R_BRA] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, r_bra_finished, r_bra_reset), [TD_BACKSPACE] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, back_finished, back_reset, 150),
};
